...
////    public static void ChangeVolumeOf(string app)
////    {
////        foreach (string name in EnumerateApplications())
////        {
////            Attune.Log("name:" + name);
////            if (name == app)
////            {
////                // display mute state & volume level (% of master)
////                Attune.Log("Mute:" + GetApplicationMute(app));
////                Attune.Log("Volume:" + GetApplicationVolume(app));
